...
#End If
        ...
        Private Function AnonymousMethod1(ByVal _sender As Object, ByVal args As CreateCustomObjectSpaceProviderEventArgs, ByVal clientDataServer As IDataServer, ByVal securityClient As ServerSecurityClient) As Object
